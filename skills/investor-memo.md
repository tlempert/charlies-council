...
- **The ceiling is exact, not a rounding target.** The validator counts words of reading — citation tags and the source list excluded — and rejects anything over 1,500; write for 1,200–1,350 so a rewrite has somewhere to cut from.
...
- Style notes from the gate, when supplied, are wording and labelling points to apply; they never change a number.
