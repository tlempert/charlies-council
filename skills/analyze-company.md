...
2. **PASS with ≤ 3 published-number MAJORs → done.** `cd /Users/tallempert/src-tal/investor && D=/tmp/silicon_council/{TICKER} && ./venv/bin/python3 scripts/gate_policy.py style-notes $D`. Record `step {TICKER} gate done`. Go to Step 7.
